...
class TrainPipeline:
    ...
    def start_model_trainer(self, data_transformation_artifact:DataTransformationArtifact) -> ModelTrainerArtifact:
        try:
            ...
            model_tranier_artifact = model_trainer.initiate_model_trainer()
    ...
    def start_model_evaluation(self, data_validation_artifact:DataValidationArtifact, model_trainer_artifact:ModelTrainerArtifact) -> ModelEvaluationArtifact:
        try:
            ...
            model_eval = ModelEvaluation(model_eval_config = model_eval_config,model_trainer_artifact=model_trainer_artifact,
    ...
    def start_model_pusher(self, model_evaluation_artifact:ModelTrainerArtifact):
    ...
    def run_pipeline(self):
        try:
            ...
            if not model_eval_artifact.is_model_accepted:
                raise Exception("Trained model is not better than production model.")
